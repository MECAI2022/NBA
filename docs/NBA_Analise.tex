...
\caption{Avaliação de vazios pré-tratamento}
\end{figure}
...
\caption{Avaliação de vazios pós-tratamento}
\end{figure}
...
\caption{Scree plot de variâncias explicadas por autovalores PCA}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.9\textwidth,height=\textheight]{imagens/4.png}
\caption{Impacto componentes PCAs na dispersão dos melhores ranqueados na NBA}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.9\textwidth,height=\textheight]{imagens/5.png}
\caption{Mapa de calor de correlações de pearson}
\end{figure}
...
\caption{Impacto componentes PCAs na dispersão dos melhores ranqueados na NBA, sem variáveis correlacionadas}
\end{figure}
...
\caption{Curvas de Andrews para principais variáveis para determinação de Rank NBA}
\end{figure}
...
\caption{Entendendo impacto das variáveis com RadViz}
\end{figure}
...
\caption{Evolução das características do jogo com RadViz}
\end{figure}
...
\caption{Chernoff faces para temporada de 2022 regular (entendendo o estilo de jogo de diferentes times)}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{imagens/21.jpeg}
\caption{Tabela da temporada regular de 2022 (conferência oeste)}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.8\textwidth,height=\textheight]{imagens/22.jpeg}
\caption{Tabela da temporada regular de 2022 (Conferência Leste)}
\end{figure}
...
\caption{Chernoff Faces do Golden State Warriors ao longo dos anos, mudança do~estilo~de~jogo}
\end{figure}
